...
и т.п.). Они НЕ являются доменными и не имеют доменной категории — 404 от внешнего API
не должен превращаться в HTTP 404 наружу (необработанными они дадут 500).
"""
